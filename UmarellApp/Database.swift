...
class Database {
    ...
    static func creaEventiDiProva() {
        ...
        uno.data = Date()
        uno.prezzo = 55
        uno.copertinaUrl = "http://images.unsplash.com/photo-1489001606409-a7fd2655b8da?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80"
        ...
        due.data = Date()
        due.prezzo = 55.0
        due.copertinaUrl = "http://images.unsplash.com/photo-1465493251445-c6af8fc40b7a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1353&q=80"
        ...
        tre.data = Date()
        tre.prezzo = 55.0
        tre.copertinaUrl = "http://images.unsplash.com/photo-1465493251445-c6af8fc40b7a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1353&q=80"
